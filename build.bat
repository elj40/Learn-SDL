...
gcc -g -Wall -o "SDL_Text_Renderer.exe" "05_SDL_Text_Renderer.c" -I%SDL_INCLUDE% -L%SDL_LIBS%  -L%SDL_TTF_PATH%\lib -lmingw32 -lSDL2_ttf -lSDL2main -lSDL2  

if %errorlevel% neq 0 exit /b %errorlevel%

REM SDL_Window.exe
REM SDL_Text.exe
SDL_Text_Renderer.exe
